...
source_folder = 'C:/SBOM_DEMO/SBOM_MAY_v2/backend/Scan'

# Destination folder where the file will be copied
destination_folder = 'C:/SBOM_DEMO/SBOM_MAY_v2/backend/Reports/Syft_tool'

# Get the current date and time
current_time = datetime.now().strftime('%Y-%m-%d_%H-%M-%S')

# Get the file name from the source folder
file_name = 'sbom.syft.json' # Replace with the actual file name
