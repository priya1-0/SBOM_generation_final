...
function  CreateMsSbomWorkspace() {
  ...
  const handleDelete = async (e) => {
    ...
    return(
     <div>
      ...
      <a 
      href="http://localhost:5000/docdownload"
      target="_blank" 
      >
    ...
    <h4><label><span style={{color: "RGB(16,16,235)"}}>Step 1:</span> Lets create work space</label></h4>
      ...
      Sorry, your browser doesn't support videos.
        ...
        <Link to="/uploadMsSbom" className="nav-link"><button class="btn btn-primary" >Proceed</button></Link> 
      </div>
    </div>
...
export default CreateMsSbomWorkspace