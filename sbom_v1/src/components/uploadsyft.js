...
function UploadSyftcomponent() {
  ...
  const handleScan = async (e) => {
    ...
    const response = await fetch('http://localhost:5000/syftscan', {
      method: 'GET',
      headers: {
...
// }
  ...
  return (
    ...
    <a 
      href="http://localhost:5000/downloadsyft"
      target="_blank" 
      >
...
export default UploadSyftcomponent
