...
app.get('/scansoup', (req,res) => {
  ...
  let commandOne = "C:/SBOM/SBOM/cyclonedx-win-x64.exe convert --input-file C:/SBOM/SBOM_OCT_v1/backend/SoupList.csv --output-file C:/SBOM/SBOM_OCT_v1/backend/Output/cyclonedx_sbom.xml --output-format xml";
...
app.get('/MsSbomscan', (req,res) => {
  console.log("received soup scan request")
  let commandOne = "sbom-tool generate -b C:/SBOM/SBOM_OCT_v1/backend/Scan -bc C:/SBOM/SBOM_OCT_v1/backend/Scan -nsb https://azsxd.com -pn test -pv 1.0 -ps test";
...
app.get('/syftscan', (req,res) => {
  ...
  let commandOne = " syft C:/SBOM/SBOM_OCT_v1/backend/Scan -o json=C:/SBOM/SBOM_OCT_v1/backend/Scan/sbom.syft.json";
