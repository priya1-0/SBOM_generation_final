...
function  CreateSoupWorkspace() {
  ...
  const handleDelete = async (e) => {
        ...
        const response = await fetch('http://mspm7awebd0001.cfrf.medtronic.com:5000/soupdelete', {
          method: 'GET',
        })
    ...
    <h4><label><span style={{color: "RGB(16,16,235)"}}>Step 1:</span> Lets create work space</label></h4>
      ...
      Sorry, your browser doesn't support videos.
        ...
        <Link to="/uploadexcel" className="nav-link"><button class="btn btn-primary" >Proceed</button></Link> 
      </div>
    </div>
...
export default CreateSoupWorkspace